...
namespace HybridPages.Server.Migrations
{
    ...
    [Migration("20240124104040_Add Input Field Types")]
    partial class AddInputFieldTypes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HybridPages.Shared.Models.Forms.InputFieldAttribute", b =>
                {
                    ...
                    b.HasIndex("InputFieldAttributeTypeId");
            ...
            modelBuilder.Entity("HybridPages.Shared.Models.Forms.InputField", b =>
                {
                    b.HasOne("HybridPages.Shared.Models.Forms.Types.InputFieldType", "InputFieldType")
                        .WithMany()
                        .HasForeignKey("InputFieldTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("InputFieldType");
                });

            modelBuilder.Entity("HybridPages.Shared.Models.Forms.InputFieldAttribute", b =>
                {
                    b.HasOne("HybridPages.Shared.Models.Forms.Types.InputFieldAttributeType", "InputFieldAttributeType")
                        .WithMany()
                    ...
                    b.Navigation("InputFieldAttributeType");
                });
